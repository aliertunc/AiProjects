...
public class Program
{
    ...
    private static void CreateVideo(string imagesFolder, string audioPath, string outputPath)
    {
        ...
        string pattern = Path.Combine(imagesFolder, "frame%03d.png");
        string args = $"-y -r 1 -i \"{pattern}\" -i \"{audioPath}\" -c:v libx264 -c:a aac -strict experimental -shortest \"{outputPath}\"";
